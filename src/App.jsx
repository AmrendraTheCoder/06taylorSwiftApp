...
function App() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <header className="text-center text-2xl font-bold mb-8 text-pink-800 bg-pink-200 rounded-lg p-4">
      Hi Netra, even the bravest hearts get a little shaky sometimes. But remember, you are stronger than you know.
      </header>
